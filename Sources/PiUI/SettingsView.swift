...
// Self-contained native Settings UI using a tabbed window (macOS standard ⌘, pattern).
// No NavigationSplitView — just tabs.
...
extension View {
  /// Applies the persisted theme mode as a color scheme.
...
/// Plain (non-reactive) reads for code that isn't a View.
struct AppSettings {
  static var fontSize: Double { 13 }
  static var monoFontName: String { "" }  // empty => system monospaced
