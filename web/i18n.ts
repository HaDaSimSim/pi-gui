...
const ko: Record<I18nKey, string> = {
  ...
  "queue.steer": "즉시 개입",
  "queue.followUp": "다음 차례",
  "queue.steerHint": "즉시 개입: 지금 에이전트를 이 메시지로 중단·유도",
  "queue.followUpHint": "다음 차례: 현재 턴이 끝난 뒤 이 메시지 전달",
  "queue.edit": "수정 (입력창으로 되돌림)",
  "queue.delete": "대기열에서 제거",
